...
def main(page: ft.Page):
    ...
    def route_change(route):
        page.views.clear()
        header = ft.Container(bgcolor=ft.colors.GREY_900, padding=15, border_radius=10, content=ft.Row(alignment=ft.MainAxisAlignment.SPACE_BETWEEN, controls=[ft.Text("نظام الجمعات", size=14, color=ft.colors.GREY_400), total_balance_text, total_retracted, ft.IconButton(ft.icons.NOTIFICATIONS, icon_color=GREY, on_click=lambda _: page.go("/notifications"))]))
