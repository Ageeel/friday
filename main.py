...
def main(page: ft.Page):
        ...
        if data:
            ...
            for key, val in data.items():
                ...
                if view_mode == "retracted":
                    ...
                    profile_img = val.get("img", "profile.png")
    ...
    # --- جلب البيانات في الخلفية بدون أي تعليق وإخفاء زر التحديث أثناء التحميل ---
    def load_data(e=None):
        ...
        def fetch_data():
            nonlocal all_data
            try:
                res = requests.get(DB_URL, timeout=6)
