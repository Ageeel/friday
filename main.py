...
def main(page: ft.Page):
    ...
    def render_data(data, query=""):
        ...
        net_balance = total_balance - total_withdrawals
        tools_section.update_stats(total, paid, pending)
        total_balance_text.value = f"الرصيد {net_balance}" 
    ...
    def route_change(route):
        ...
        header = ft.Container(
            ...
            content=ft.Row(
                ...
                controls=[
                    ft.Text( f"عدد الجمعات {total_fridays}", size=14, color=ft.colors.GREY_400), 
                    total_balance_text, 
                    total_retracted, 
