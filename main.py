...
def main(page: ft.Page):
    ...
    onboarding_container = ft.Container(
        ...
        content=ft.Column(
            ...
            controls=[
                ft.Icon(ft.icons.WAVES, size=80, color=ft.colors.ORANGE_400), 
                ft.Text("مرحباً بك في كل جمعة", size=24, color="white"), 
                ft.ElevatedButton("ابدأ", on_click=close_onboarding)
            ]
        )
    )
    ...
    def route_change(route):
        ...
        ], floating_action_button=ft.FloatingActionButton(icon=ft.icons.REFRESH, bgcolor=ft.colors.ORANGE_600, on_click=load_data, width=45, height=45))
