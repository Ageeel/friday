    ...
    def render_data(data, query=""):
        ...
        if data:
            for key, val in data.items():
                ...
                #select the person icon color
                if val.get("m") == 0:
                	p_icon_col = ft.colors.ORANGE_100
                elif val.get("m") == 1:
                	p_icon_col = ft.colors.ORANGE_600
                else: 
                	p_icon_col = ft.colors.ORANGE_900
        ...
        total_balance_text.value =f"{(total_balance - total_withdrawals):,.0f}"
    ...
    def route_change(route):
        ...
        margin=ft.margin.all(0),
            ...
            content=ft.Container(
                padding=20,
                border_radius=10,
                gradient=ft.LinearGradient(begin=ft.alignment.bottom_left, end=ft.alignment.bottom_right, colors=["#222222", ft.colors.GREY_900]),
                content=ft.Column(spacing=10, controls=[
                    ...
                    ft.Row(alignment=ft.MainAxisAlignment.SPACE_EVENLY, controls=[
                        ...
                        ft.VerticalDivider(), 
                        ft.Column([ft.Text("الأموال", size=13, color=ft.colors.GREY_300), total_balance_text], horizontal_alignment=ft.CrossAxisAlignment.CENTER),
                        ft.VerticalDivider(), 
