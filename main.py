...
def main(page: ft.Page):
    ...
    # حقل البحث المحدث بحواف دائرية وبدون حدود
    ...
    loading_overlay = ft.Container(
        content=ft.Column(
            ...
            controls=[
                ...
                ft.Text("جارِ التحميل، انتظر قليلاً", color=ft.colors.WHITE, size=16)
            ]
        ),
        visible=False,
