...
# تعديل مسار الكاش ليعمل على أندرويد وجميع المنصات بصلابة
...
def main(page: ft.Page):
    ...
    # --- تحسين معالجة الكاش لضمان الحفظ والقراءة السليمة ---
    def load_data(e=None):
        ...
        def fetch_data():
            ...
            # 1. محاولة تحميل من الكاش المحلي أولاً (كاحتياطي سريع)
            ...
            # 2. جلب البيانات الحديثة من الخادم وتحديث الكاش
            try:
                ...
                if res.status_code == 200 and res.json():
                    ...
                    try:
                        ...
                        print("Cache Write Error:", write_err)
            except Exception as fetch_err:
                print("Fetch Error (Using Cache if available):", fetch_err)

            # 3. تحديث الواجهة فورياً بالبيانات المتاحة
