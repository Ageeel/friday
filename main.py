...
# إنشاء مجلد التخزين المؤقت للصور محلياً
CACHE_DIR = "img_cache"
...
def main(page: ft.Page):
    ...
    # قاموس لتخزين المسارات المحلية للصور في الذاكرة
    images_cache = {}
    ...
    # دالة لتحميل وتخزين الصور محلياً مع صيغة file:// الصحيحة
            ...
            for key, val in data.items():
                if isinstance(val, dict):
                    ...
                    if img_url and img_url.startswith("http"):
                        ...
                        file_path = os.path.join(CACHE_DIR, f"{key}{ext}")
                        abs_path = os.path.abspath(file_path)
                        formatted_path = f"file:///{abs_path.replace(os.path.sep, '/')}"
                        
                        if os.path.exists(file_path):
                            images_cache[key] = formatted_path
                        else:
                            try:
        ...
        if data:
            ...
            for key, val in data.items():
                ...
                if view_mode == "retracted":
                    ...
                    # استخدام المسار المحلي المنسق أو الرابط المباشر كخيار احتياطي
    ...
    def load_data(e=None):
        ...
        def fetch_data():
            ...
            # بدء تحميل وتخزين الصور محلياً في الخلفية
