...
def main(page: ft.Page):
    ...
    # استخدام مسار العمل الداخلي للتطبيق وهو آمن وله صلاحيات كتابة في الـ APK
    CACHE_DIR = os.path.join(os.getcwd(), "img_cache")
            ...
            for key, val in data.items():
                if isinstance(val, dict):
                    ...
                    if img_url and img_url.startswith("http"):
                        ...
                        # تصحيح مسار الـ URI ليعمل بكفاءة مطلقة على أندرويد وباقي الأنظمة دون أخطاء
                        if os.name == 'nt':
